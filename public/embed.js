(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      "  pointer-events:none;",
      "  background:linear-gradient(165deg,rgba(89,1,1,0.95) 0%,rgba(46,16,20,0.92) 8%,rgba(15,5,8,0.93) 30%,rgba(18,8,10,0.9) 50%,rgba(20,10,12,0.9) 66%,rgba(43,17,17,0.92) 100%);",
